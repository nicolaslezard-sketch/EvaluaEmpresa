...
export const metadata: Metadata = {
  title: "Evaluación de proveedores y monitoreo de terceros",
  description:
    "Software para evaluar proveedores, clientes y contrapartes con metodología estructurada, comparativa entre ciclos y salida ejecutiva clara.",
  alternates: {
    canonical: "/",
  },
};
...
const organizationJsonLd = {
  ...
  logo: "https://www.evaluaempresa.com/favicon.ico",
};
          ...
          <div className="container-page py-12 sm:py-16 lg:py-20">
            <div className="max-w-4xl">
              ...
              <p className="mt-5 max-w-3xl text-base leading-7 text-zinc-600 sm:text-lg sm:leading-8">
                ...
                ciclos y una salida ejecutiva clara para decidir con más
                criterio.
              </p>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-6 text-zinc-500">
                Probalo durante 21 días y entendé rápido qué cambió, qué
                requiere atención y qué conviene revisar ahora.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container-page grid gap-12 md:grid-cols-[1fr_1fr] md:items-start">
            <div className="max-w-2xl">
              ...
              <p className="mt-5 text-base leading-7 text-zinc-600">
                Cuando cada evaluación depende de planillas, documentos sueltos
                o criterios cambiantes, se vuelve más difícil detectar
                deterioros, priorizar señales relevantes y justificar por qué
                continuar, revisar o escalar un caso.
              </p>
            </div>
            ...
            <div className="grid gap-4">
              ...
              <div className="card p-6">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-600">
                  No siempre queda claro qué empeoró, qué mejoró y dónde
                  conviene intervenir antes de que el problema crezca.
                </p>
              </div>
              ...
              <div className="card p-6">
                ...
                <p className="mt-2 text-sm leading-6 text-zinc-600">
                  Sin una salida ejecutiva consistente, respaldar internamente
                  una decisión se vuelve más difícil.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container-page">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 text-base leading-7 text-zinc-600">
                No es solo un score. Es una forma más ordenada de ver
                exposición, detectar cambios, priorizar señales y dejar mejor
                soporte para decidir.
              </p>
            </div>
        ...
        <section className="bg-white py-20">
          <div className="container-page">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight text-zinc-900">
                Un proceso simple para ordenar evaluaciones y seguir su
                evolución
              </h2>
              <p className="mt-4 text-base leading-7 text-zinc-600">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              <div className="card p-6">
                ...
                <p className="mt-3 text-sm leading-6 text-zinc-600">
                  Registrá el tercero que querés seguir y centralizá su
                  evaluación en un solo lugar.
                </p>
              </div>
            ...
            <p className="mt-8 max-w-3xl text-sm leading-6 text-zinc-500">
              ...
              más trazabilidad sobre lo que cambió.
            </p>
          </div>
        </section>
        ...
        <section className="border-y border-sky-100 bg-sky-50/40 py-20">
          <div className="container-page">
            <div className="max-w-3xl">
              ...
              <h2 className="mt-4 text-3xl font-semibold tracking-tight text-zinc-900">
                Casos donde una evaluación estructurada realmente hace
                diferencia
              </h2>
            </div>
            ...
            <div className="mt-8">
              ...
              <Link
                ...
                className="inline-flex items-center text-sm font-medium text-sky-800 hover:text-sky-900"
              >
          ...
          <div className="container-page">
            ...
            <div className="mt-10 grid gap-6 md:grid-cols-3">
              ...
              <div className="rounded-3xl border border-emerald-200 bg-white p-7 shadow-[0_12px_32px_rgba(16,185,129,0.08)]">
                ...
                <p className="mt-3 text-base leading-7 text-zinc-600">
                  Sumá más capacidad, más memoria histórica y alertas
                  persistidas para seguir riesgos no resueltos entre ciclos.
                </p>
        ...
        <section className="border-t border-zinc-200 bg-linear-to-b from-white to-sky-50/40 py-20">
          <div className="container-page text-center">
            <h2 className="text-3xl font-semibold tracking-tight text-zinc-900">
              Empezá con una prueba gratuita y pasá a seguimiento continuo
              cuando lo necesites.
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-zinc-600">
              Probá el producto, entendé el flujo y elegí el plan que mejor
              encaje con tu nivel de seguimiento cuando realmente lo necesites.
            </p>
